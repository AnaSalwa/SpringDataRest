...
function updateCalendar(selectedDate) {
    ...
    dayElements.forEach(dayElement => {
      // Remove the 'event-marked' class from all days
      dayElement.classList.remove('event-marked');

      // Add the 'event-marked' class to the selected date
  ...
  // Call the initCalendar function
  initCalendar();
  ...
  document.addEventListener('submit', function (event) {
    ...
    // Check if the submitted form is the event form
    if (form.id === 'eventForm') {
      ...
      // Update the calendar with the marked date

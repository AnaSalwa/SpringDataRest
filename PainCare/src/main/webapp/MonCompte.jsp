        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Paramètres /</span> Mon compte</h4>
                  ...
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="deleteUser.jsp"
                        ><i class="bx bx-bell me-1"></i> Supprimer mon compte </a
                      >
                    </li>
          ...
          <!--     <img class="card-img" src="data:image/jpeg;base64, ${publication.photoBase64}" alt="Card image" width="80" height="300" />
                  ...
                  --> 
                      ...
                      <!--    <a href="PhotoServlet?action=getMyPic&id_user=<%= user.getId() %>" class="btn btn-success me-2 mb-4"> 
							   MA PHOTO
							</a>--> 
                  ...
                  <!--     <div class="card-body">
                      <div class="d-flex align-items-start align-items-sm-center gap-4">
                        <img
                          ...
                          id="uploadedAvatar"
                        />
                     <img class="card-img" src="data:image/jpeg;base64,  //user.getPhoto() " alt="Card image" width="80" height="300" />
                ...
                <!--   <label for="photo" class="btn btn-success me-2 mb-4" tabindex="0">
							        <span class="d-none d-sm-block">Voir mon actuelle photo</span>
							        <i class="bx bx-upload d-block d-sm-none"></i>
							    </label>-->  
                  
                <!--     <form action="UserServlet?action=insertPhoto&id_user=<%= user.getId() %>" method="post" enctype="multipart/form-data">
					    
					        <label for="photo" class="btn btn-warning me-2 mb-4" tabindex="0">
					      ...
					      <button type="submit" class="btn btn-outline-secondary account-image-reset mb-4">
					        ...
					        <p class="text-muted mb-0">JPEG,ou PNG sont autorisés. Taille maximale de 800 Ko</p>
					    </div>
                    ...
                    <hr class="my-0" />
                    <div class="card-body">
                      <form id="formAccountSettings" action="UserServlet?action=updateUser" method="POST">
						    <div class="row">
						        <div class="col-md-6">
						            <div class="mb-3">
						                <label for="nom" class="form-label">Nom</label>
						                <input class="form-control" type="text" id="nom" name="nom" value="<%= user.getNom() %>" autofocus />
						            </div>
						
						            <div class="mb-3">
						                <label for="prenom" class="form-label">Prénom</label>
						                <input class="form-control" type="text" name="prenom" id="prenom" value="<%= user.getPrenom() %>" />
						            </div>
						            ...
						            <div class="mb-3">
						                ...
						                <div class="input-group input-group-merge">
						                    <input type="password" id="password" name="password" class="form-control" placeholder="Entrer votre mot de passe actuel pour modifier" />
						                </div>
						            </div>
						        </div>
						    </div>

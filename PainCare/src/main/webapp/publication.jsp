...
<html lang="en" class="light-style layout-navbar-fixed layout-menu-fixed layout-compact " dir="ltr" data-theme="theme-semi-dark" data-assets-path="../../assets/" data-template="vertical-menu-template">
  ...
  <body>
	...
	<div class="row">
    <div class="col">
        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Communauté /</span> Publications </h4>
    </div>
	    <div class="col text-end">
	        <a href="ajouterpublication.jsp" class="btn btn-success btn-buy-now">Publier maintenant</a>
	    </div>
	</div>
        ...
        <div class="col-12 mb-3">
            <div class="card h-100">
                <div class="row g-0">
                    <!-- Image on the left -->
                    <div class="col-md-6">
					 <c:if test="${not empty publication.photo}">
                    ...
                    <div class="col-md-6">
                        <div class="card-body">
                            <h5 class="card-title">
                                ...
                                <strong style="text-transform: uppercase;">${publication.nom}</strong>
                                <strong>${publication.prenom}</strong>
                            </h5><br>
                        ...
                        <br>
                              <div class="modal-footer">
                               <a href="CommentaireServlet?action=getAllComments&id_publication=${publication.id}" type="button"  class="btn btn-success" >
								...
								<a href="CommentaireServlet?action=getMyComments&id_publication=${publication.id}&id_user=<%= user.getId() %>" type="button" class="btn btn-info">
								Mes commentaires</a>
                        ...
                        <!--  Fin modal Comenter-->
                           ...
                           <style>
							  .btn-rose {
							    color: #fff;
							    background-color: #ff4081; /* Couleur rose personnalisée, vous pouvez ajuster selon vos préférences */
							    border-color: #ff4081; /* Couleur de la bordure */
							  }
							  .btn-rose:hover {
							    background-color: #d81b60; /* Couleur rose légèrement plus foncée au survol */
							    border-color: #d81b60;
							  }
							</style>
							
							<!-- Utilisez la nouvelle classe personnalisée -->
							<button type="button" class="btn btn-rose" data-bs-toggle="modal" data-bs-target="#modalCenter">
							  Commenter
							</button>

...
>
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="frontend/assets/vendor/css/pages/page-misc.css" />
    <!-- Helpers -->
  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        ...
        <div class="mt-3">
          <img
            src="frontend/assets/img/illustrations/page-misc-error-light.png"
    ...
    <script src="frontendassets/vendor/libs/jquery/jquery.js"></script>

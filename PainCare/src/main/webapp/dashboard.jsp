            ...
            <li class="menu-item">
	         ...
	         <li class="menu-item">
			  <!--   <a href="deleteUser.jsp?nom= //user.getNom() %>" class="menu-link"> -->
			     <a href="deleteUser.jsp" class="menu-link">
...
<h4 class="py-3 mb-4"><span class="text-muted fw-light">Dashboard /</span> Hi ${User.prenom}</h4>
...
<!-- Style variation -->
<h5 class="pb-1 mb-4">Que recherchez-vous?</h5>
<div class="row">
  <div class="col-md-6 col-xl-4">
  <a href="info.jsp" class="card-link">
    <div class="card bg-primary text-white mb-3">
      <div class="card-header">    <strong>  <box-icon name='notepad'></box-icon></strong>
      </div>
      <div class="card-body">
        <h5 class="card-title text-white">Informations sur l'endometriose</h5>
        <p class="card-text">
          Trouvez des articles informatifs, des guides et des documents educatifs sur l'endometriose
        </p>
      </div>
  </div>
  </a>
  ...
  <div class="col-md-6 col-xl-4">
  <a href="publication.jsp" class="card-link">
    <div class="card bg-secondary text-white mb-3">
      <div class="card-header"><box-icon name='chat'></box-icon></div>
      <div class="card-body">
        <h5 class="card-title text-white">Forums de discussion</h5>
        <p class="card-text">
          Echanger vos experiences, partager des conseils et soutenez-vous mutuellement.
        </p>
      </div>
    </div>
    </a>
  ...
  <div class="col-md-6 col-xl-4">
  <a href="blogs2.jsp" class="card-link">
    <div class="card bg-success text-white mb-3">
      <div class="card-header"><box-icon type='logo' name='blogger'></box-icon></div>
      <div class="card-body">
        <h5 class="card-title text-white">Blogs et conseils</h5>
        <p class="card-text">
          Decouvrez des blogs et profitez de conseils sur divers aspects du mode de vie qui peuvent vous aider.
        </p>
      </div>
    </div>
    </a>
  ...
  <a href="" class="card-link">
    <div class="card bg-danger text-white mb-3">
      <div class="card-header"><box-icon name='calendar'></box-icon></div>
      <div class="card-body">
        <h5 class="card-title text-white">Calendrier</h5>
        <p class="card-text">
     Creez votre calendrier personnalise avec des dates importantes et des rendez-vous .
  ...
  <div class="col-md-6 col-xl-4">
  <a href="Diagnostic.jsp" class="card-link">
    <div class="card bg-warning text-white mb-3">
      <div class="card-header"><box-icon name='test-tube'></box-icon></div>
      <div class="card-body">
        <h5 class="card-title text-white">Test de diagnostic</h5>
        <p class="card-text">
          Passez rapidement un test de diagnostic et decouvrez votre potentiel d'endometriose.
        </p>
      </div>
    </div>
    </a>
  ...
  <div class="col-md-6 col-xl-4">
  <a href="Graphes.jsp" class="card-link">
    <div class="card bg-info text-white mb-3">
      <div class="card-header"><box-icon name='line-chart'></box-icon></div>
      <div class="card-body">
        <h5 class="card-title text-white">Evolution de la douleur</h5>
        <p class="card-text">
          Explorez votre parcours de douleur et restez informes sur son evolution au cours du temps.
        </p>
      </div>
    </div>
    </a>

...
<%@ page import="com.JAVA.Bean.CommentaireBean" %>
 ...
 <div class="row">
    ...
    <div class="col-md-12 mb-4">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="dashboard.jsp" type="button" class="btn btn-danger">Retour</a>
        </div>
                        ...
                        <div class="card-body">
                            <div class="comment">
                                ...
                                <div class="comment-content">
                                    ...
                                    <!-- Ajoutez d'autres informations du commentaire au besoin -->
                                </div>
                            </div>
                            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalCenter">
                             ...
                             <a href="CommentaireServlet?action=deleteComment&id_commentaire=${comments.id}" type="button"  class="btn btn-warning" >
								 Supprimer
								 </a>
                          ...
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                      <form id="commentForm" method="post" action="CommentaireServlet?action=updateComment&id_commentaire=${comments.id}">
                              
                                <div class="row">
                                
                                  <div class="col mb-3">
                                    <label for="nameWithTitle" class="form-label">Commentaire</label>
                                    <input
                                      type="text"
                                      id="commentaire"
                                      name="commentaire"

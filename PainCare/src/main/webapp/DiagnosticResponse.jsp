...
>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h3 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Suivre votre état/</span> Test de diagnostic </h3>
            ...
            <div class="row">
  <!-- Left Section for Test Results -->
  <div class="col-md-6 h-100 d-flex flex-column">
    <div class="card mb-3">
      <div class="card-header d-flex align-items-center justify-content-between">
        <h2 class="mb-0">Résultat de votre test :</h2>
      </div>
      <div class="card-body">
        <form class="d-flex flex-column h-100">
          ...
          <div class="row justify-content-end">
            <div class="col-sm-10">
              <a href="Diagnostic.jsp" type="submit" class="btn btn-primary">Refaire le test </a>
            </div>
          </div>
        </form>
      </div>
  ...
  <div class="col-md-6 h-100">
    <div class="card mb-3 h-100">
      <div class="card-header d-flex align-items-center justify-content-between">
        <img src="frontend/assets/img/pub2.jpeg" class="h-100" width="400" height="400">
      </div>
    </div>
  </div>
</div>

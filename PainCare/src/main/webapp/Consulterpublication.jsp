...
<h4 class="py-3 mb-4">
  <span class="text-muted fw-light"> Chat /</span> Publications
</h4>
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="card mb-4"><br>
     <h4>  -->    ${publication.proprietaire} </h4>
      <!-- Account -->
      <div class="card-body">
        <div class="d-flex align-items-start align-items-sm-center gap-4">
          <img src="images/jee2.jpg" alt="user-avatar" class="d-block rounded" height="100" width="100" id="uploadedAvatar" />
          <div class="button-wrapper">
          
      <h2>${publication.titre} </h2>
            <p> ${publication.description} </p>
            <a href="publicationServlet?id=${publication.id}&id_user=${User.id}&action=voircmt" class="btn btn-success" >Voir les commentaires</a>
          </div>
        </div>
      </div><br> 
    ...
    <br>
      <div class="card-body">
        <form action="commentaireServlet?action=Ajoutercommentaire" method="post">
						  
        
          <div class="row">
            <div class="mb-3 col-md-6">
              <label for="firstName" class="form-label">Votre commentaire</label>
              <input class="form-control" type="text" id="firstName" name="firstName" value="" autofocus />
            </div>
            <div class="mb-3 col-md-6"><br>
            <button type="submit" class="btn btn-primary me-2">Ajouter</button>
            <a href="publicationServlet" class="btn btn-danger me-2">Retour</a>
            </div>
...
<style>
  .btn btn-success { width : 120px}</style>
</html>

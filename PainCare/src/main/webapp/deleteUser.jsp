        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Paramètres/</span> Supprimer mon compte </h4>

              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                      <a class="nav-link " href="MonCompte.jsp"><i class="bx bx-user me-1"></i> Mon compte</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link active" href="deleteUser.jsp"
                        ><i class="bx bx-bell me-1"></i> Suppriner mon compte </a
                      >
                    </li>
                      ...
                      <div class="mb-3 col-12 mb-0">
                        <div class="alert alert-warning">
                          ...
                          <p class="mb-0">Une fois votre compte supprimé, vous ne pourrez plus revenir en arrière. Soyez-en sûr, s'il vous plaît.</p>
					          	  ...
					          	  <%
					    // Récupérer le nom de l'utilisateur depuis les paramètres de la requête
					    String nomUtilisateur = request.getParameter("nom");
					%>
					
					<form action="UserServlet?action=deleteUser&nom=<%= nomUtilisateur %>" method="post">

  ...
  <body>
    ...
    <div class="layout-wrapper layout-content-navbar">
      ...
      <div class="content-wrapper">
		...
		<h4 class="py-3 mb-4">
		  <span class="text-muted fw-light">Publications /</span> Ajouter publication
		</h4>
		...
		<div class="row">
		  ...
		  <div class="col-md-6">
		    <div class="card mb-4">
		      <h5 class="card-header">Nouvelle publication</h5>
			<!--  	<form action="PublicationServlet?action=insertPub&id_user=<%= user.getId() %>" method="post">
		     
			    <div class="card-body">
			        <div class="mb-3">
			            <label for="titre" class="form-label">titre</label>
			            <input type="text" name="titre" class="form-control" id="titre" placeholder="votre titre" />
			        </div>
			    ...
			    <div class="text-center">
			        ...
			        <input type="submit" value="Ajouter" class="btn btn-success rounded-pill mb-3">
			        <a href="dashboard.jsp" class="btn btn-danger rounded-pill mb-3">Retour</a>
			    </div>
			</form>-->
			
			
			<form action="PubServlet?action=insertPub&id_user=<%= user.getId() %>" method="post" enctype="multipart/form-data">
			    <div class="card-body">
			        <div class="mb-3">
			            <label for="titre" class="form-label">Titre</label>
			            <input type="text" name="titre" class="form-control" id="titre" placeholder="Votre titre" />
			...
			<div class="col-md-6">
			    ...
			    <img src="frontend/assets/img/pub1.jpeg" alt="Description de l'image" class="img-fluid" height="8100" width="800">
			</div>

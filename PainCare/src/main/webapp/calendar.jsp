...
<br>
 <div class="d-flex justify-content-between mb-3">
        <button id="showEventFormBtn" class="btn btn-primary"> + Ajouter un évenement</button>
        <a href="EventServlet?action=getMine&id_user=<%= user.getId() %>" class="btn btn-success">Voir mes évenements</a>
...
<style>
  .event-marked {
    background-color: #4caf50; /* Green color or any color of your choice */
    color: #fff; /* White text or any text color of your choice */
  }
</style>
